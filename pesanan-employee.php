<?php
    ...
    if(isset($_GET['message'])){
        if(orderedFood($_GET['message'], $_SESSION['idEmployee']) > 0){
            echo " 
                <script>
    ...
    $payment_Max = queryFunction("SELECT * FROM payment ORDER BY id_payment DESC LIMIT 1");
    $length = $payment_Max[0]['id_payment'];
    $orders = [];
    for($i=1; $i<=$length; $i++){
        $query = "SELECT a.id_payment AS payment, b.username AS username, a.quantity AS quantity, c.nama AS nama, b.id_user AS id_user
                    FROM payment AS a
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light sticky-top">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <li class="nav-item navbar-menu">
                <a class="nav-link text-warning text-menu" href="pesanan-employee.php">Pesanan</a>
            </li>
            <li class="nav-item navbar-menu">
    ...
    <div class="container mt-4 p-3 d-flex flex-column">
        <a href="history-payment.php" class="btn btn-dark">History Payment</a>
        <?php $i= 0; $u=1?>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-5">
                            ...
                            <div class="col-3 pt-5">
                                <center> 
                                    <a href="pesanan-employee.php?message=<?= $i; ?>" name="ordered" class="btn btn-dark">Proceed Order</a>
                                </center>
                            </div>
                        </div>    
                        <br>

    ...
    <nav class="navbar navbar-expand-lg navbar-light sticky-top">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <li class="nav-item active navbar-menu">
                <a class="nav-link text-warning text-menu" href="home-employee.php">Home</a>
            </li>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-6 ps-5">
                <h1 class="text-hello">Hello, <?= $_SESSION['usernameEmployee']; ?></h1>
                <p class="text-welcome">Semangat Bekerja, dan mencari duit agar bisa check out shopee lalu memborong semua barang yang ada</p>
            </div>
            <div class="col-6 d-flex justify-content-center align-items-center">
                <img src="assets/logo_background/logo-search.png" alt="logo-search" class="logo-search">
            </div>
        </div>
    </div>
